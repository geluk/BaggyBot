...
<<<<<<< HEAD
			...
			BaggyBot.instance.sendMessage(channel, "StatsBot " + BaggyBot.version +" - made by baggerboot. Stats page: http://jgeluk.net/stats/ - For various help topics, use the '-help topics' command.");
=======
>>>>>>> Master
